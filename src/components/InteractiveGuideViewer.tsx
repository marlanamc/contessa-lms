                ...
                <div className="flex-1 w-full lg:w-1/2 lg:overflow-y-auto p-5 sm:p-7 lg:pl-24 lg:pr-12 flex flex-col justify-center bg-white/70">
                    <div className="w-full lg:max-w-2xl lg:mx-auto animate-fade-in-up space-y-4 sm:space-y-6">
                        ...
                        <div className="flex items-center gap-4 mb-6 md:mb-8">
                            {currentSection.icon && (
                                <div
                                    className="flex-shrink-0 w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center text-lg md:text-xl shadow-sm text-white"
                                    style={{
                                        background: "linear-gradient(135deg, #8b1c31 0%, #1b4d3e 100%)"
                                    }}
                                >
                                    {currentSection.icon}
                                </div>
