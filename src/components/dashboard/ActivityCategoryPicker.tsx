...
import { PenLine, Gamepad2, BookOpen, ClipboardList, Mic, PenTool, Volume2, Martini } from 'lucide-react';
...
const CATEGORY_CARDS: CategoryCardDef[] = [
    {
        key: 'cocktails',
        name: 'Cocktails',
        subtitle: 'The martini standard',
        icon: <Martini className="w-8 h-8 sm:w-10 sm:h-10" strokeWidth={1.5} />,
        bgColor: '#fdf2f2',  // light red
        iconColor: '#8b1c31', // burgundy
    },
    {
        key: 'grammar',
        name: 'Grammar',
...
export function ActivityCategoryPicker({
    ...
    const categoryHasActivities = useMemo(() => {
        ...
        // Cocktails
        map['cocktails'] = activities.some((a) => a.category === 'cocktails');
