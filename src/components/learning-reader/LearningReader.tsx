...
export function LearningReader({ content, onComplete, completionKey, activityId }: LearningReaderProps) {
    const router = useRouter();
    const storageKey = `learningReader:${completionKey || "guide"}:unlocked`;
    ...
    return (
        <div className="learning-reader-container min-h-screen bg-bg">
            {/* Points Toast */}
            {pointsToast && (
                <PointsToast
                    key={pointsToast.key}
            ...
            <main className="container mx-auto px-4 py-4 pb-24 md:pb-4">
                <div className="learning-reader-split-screen bg-white rounded-xl shadow-lg border border-border overflow-hidden">
