...
export default async function DashboardPage() {
    ...
    if (userRole === "teacher") {
                ...
                links: [
                    {
                        ...
                        subtitle: "Browse all training materials and guides.",
                        icon: MapIcon,
                    },
                    {
            ...
            <div className="min-h-screen bg-bg">
                ...
                <BottomNav
                    items={[
                        ...
                        { href: '/dashboard/activities', label: 'Library', icon: <MapIcon /> },
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const featuredActivityIds = Array.from(new Set(featuredAssignmentsRaw.map((a: any) => a.activityId)));
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const featuredAssignments = featuredAssignmentsRaw.map((a: any) => {
