                ...
                <header className="text-center space-y-8 animate-fade-in-up">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20">
                        ...
                        <p className="text-xs sm:text-sm uppercase tracking-[0.15em] text-primary-dark font-semibold">
                            Contessa Learning Platform
                        </p>
                    </div>

                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-text">
                        <span className="inline-block font-handwritten">Contessa</span>{" "}
                        <span className="inline-block relative font-display">
                            Companion
                            <svg className="absolute -bottom-2 left-0 w-full" height="12" viewBox="0 0 300 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2 10C52 4 148 -2 298 10" stroke="var(--color-accent)" strokeWidth="4" strokeLinecap="round" />
                            </svg>
                        </span>
                    </h1>
